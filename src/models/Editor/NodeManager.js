...
function NodeManager(document)
{
    this._doc = document;
}

NodeManager.prototype.addBehavior = function(rectNode, type)
{
...
NodeManager.prototype.addCameraPath = function(pathNode)
{
    let document = this._doc;
...
NodeManager.prototype.addCheckpoint = function(checkpointNode)
{
    let document = this._doc;
...
NodeManager.prototype.addObject = function(objectNode)
{
    let document = this._doc;
...
NodeManager.prototype.addObjectInstance = function(objectInstanceNode)
{
    let document = this._doc,
        layoutNode = this.getLayout();
...
NodeManager.prototype.addSolid = function(solidNode)
{
    let document = this._doc,
...
NodeManager.prototype.getBehavior = function()
{
    let document = this._doc,
        layoutNode = this.getLayout();
...
NodeManager.prototype.getLayout = function()
{
    let document = this._doc,
