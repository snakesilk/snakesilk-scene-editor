...
function NodeFactory(document)
{
    this._doc = document;
}

NodeFactory.prototype.createBehavior = function(type, size)
{
...
NodeFactory.prototype.createCameraPath = function()
{
...
NodeFactory.prototype.createCheckpoint = function()
{
...
NodeFactory.prototype.createObject = function(size)
{
...
NodeFactory.prototype.createObjectInstance = function(objectInstance)
{
...
NodeFactory.prototype.createRect = function(size)
{
    size = size || {};
