...
UI.prototype.applyState = function()
{
...
UI.prototype.loadLevel = function(url)
{
...
UI.prototype.createItem = function(type)
{
...
UI.prototype.mouseSelectItem = function(event, items)
{
...
UI.prototype.paintUV = function(item, faceIndex)
{
    let paletteItem = this.editor.ui.palette.getSelectedAnimation();
    if (!paletteItem) {
        this.palette.show();
        return;
    }
...
UI.prototype.setupCamera = function()
{
...
UI.prototype.setupConsole = function()
{
...
UI.prototype.setupFileView = function()
{
    /*editor.loader = {
        loadCharacterXml: function(src) {
            ...
            loader.loadObjects(src, function(objects, parser) {
                for (var characterId in objects) {
                    ...
                    var characterItem = new Items.Object(character);
...
UI.prototype.setupItemSet = function()
{
    const COLOR_MAP = {
        'cameraPath': COLORS.camera.window,
        'checkpoint': COLORS.checkpoint,
        'climbable': COLORS.behavior.climbable,
        'deathzone': COLORS.behavior.deathzone,
        'solid': COLORS.behavior.solid,
    };
...
UI.prototype.setupProperties = function()
{
...
UI.prototype.setupPalette = function()
{
...
UI.prototype.setupPanel = function()
{
    this.panel = this.workspace.find('.panel');
}

UI.prototype.setupPlayback = function()
{
...
UI.prototype.setupView = function(node)
{
    ...
    V.layers.on('change', e => {
        ...
        const action = checkbox.getAttribute('data-what') + (checkbox.checked + 0);
...
UI.prototype.setupViewport = function()
{
    ...
    viewport
        ...
        .on('dblclick', function(e) {
            ...
            if (item && item.item.TYPE === "object") {
                ...
                mat.color = new THREE.Color(COLORS.overlayPaint);
        ...
        .on('drop', e => {
            ...
            reader.addEventListener('load', e => {
                ...
                image.addEventListener('load', e => {
                    ...
                    const item = new Items.Mesh(mesh);
...
UI.prototype.setupWorkspace = function()
{
