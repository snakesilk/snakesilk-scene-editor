...
function Rectangle(object, node, vec1, vec2)
{
...
Rectangle.prototype.getComponent = function(name)
{
    let v;
    switch (name) {
    case 'x':
...
Rectangle.prototype.setComponent = function(name, value)
{
    let d, x, y,
        k = name,
        v = this.round(value),
...
Rectangle.prototype.updateGeometry = function()
{
...
Rectangle.prototype.updateNode = function()
{
    let v = this.vectors,
        n = this.node;
